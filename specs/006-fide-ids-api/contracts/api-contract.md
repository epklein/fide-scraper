...
**Base URL**: `https://app.chesshub.cloud/api/fide-ids/`

**Endpoint Path**: `/api/fide-ids/`

**Full URL**: `https://app.chesshub.cloud/api/fide-ids/`
...
**Example**:
```
GET https://app.chesshub.cloud/api/fide-ids/
...
```bash
curl -X GET "https://app.chesshub.cloud/api/fide-ids/" \
...
url = "https://app.chesshub.cloud/api/fide-ids/"
headers = {
