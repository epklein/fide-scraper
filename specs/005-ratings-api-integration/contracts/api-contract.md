...
**Date**: 2024-12-18
**Endpoint**: https://app.chesshub.cloud/api/fide-ratings/
...
**Base URL**: https://app.chesshub.cloud/api/fide-ratings/

**Full URL**: https://app.chesshub.cloud/api/fide-ratings/
...
**Request**:
```bash
curl -X POST https://app.chesshub.cloud/api/fide-ratings/ \
