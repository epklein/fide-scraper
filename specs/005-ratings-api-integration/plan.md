...
.env.example                    # Update with new env variables:
                                # FIDE_RATINGS_FIDE_RATINGS_API_ENDPOINT=https://app.chesshub.cloud/api/fide-ratings/
                                # API_TOKEN=
...
**Request**:
```http
POST https://app.chesshub.cloud/api/fide-ratings/
...
FIDE_RATINGS_API_ENDPOINT=https://app.chesshub.cloud/api/fide-ratings/
